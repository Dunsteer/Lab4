...
//drugiOperand(int) i suprotnaOperacija(Operacija*) :  funkciju koja vraća suprotnu operaciju, 
// funkciju koja vraća drugi operand,  funkciju za prikaz podataka o operaciji(naziv, drugi operand i naziv suprotne operacije), 
